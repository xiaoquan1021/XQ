...
std::vector<mitk::Point3D> xq_Math3::InterpolateCurveViaSpline(
...
int xq_Math3::FindNearestSegmentInsertionPoint(
...
bool xq_Math3::IsWithinBoundingBox(const mitk::Point3D& point, double bounds[6])
{
...
mitk::Vector3D xq_Math3::ComputeOrthogonalVector(const mitk::Vector3D& vec)
{
    mitk::Vector3D seed;
...
double xq_Math3::EuclideanDistance3D(const mitk::Point3D& p1, const mitk::Point3D& p2)
{
    double dx = p1[0] - p2[0];
    double dy = p1[1] - p2[1];
    double dz = p1[2] - p2[2];
...
double xq_Math3::DotProduct3D(const mitk::Vector3D& v1, const mitk::Vector3D& v2)
{
    return v1[0] * v2[0] + v1[1] * v2[1] + v1[2] * v2[2];
}

mitk::Vector3D xq_Math3::CrossProduct3D(const mitk::Vector3D& v1, const mitk::Vector3D& v2)
{
...
mitk::Vector3D xq_Math3::UnitVector(const mitk::Vector3D& vec)
{
...
double xq_Math3::ComputeAngleRadians(const mitk::Vector3D& v1, const mitk::Vector3D& v2)
{
...
mitk::Point3D xq_Math3::LinearInterpolate3D(const mitk::Point3D& p1, const mitk::Point3D& p2, double t)
{
    mitk::Point3D result;
