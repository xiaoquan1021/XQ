    ...
    xq_VascularGeometry* modelElement, const Params& params)
{
    ...
    {
        out.diagnostic = "TetGen: model element has no usable surface.";
        return out;
    }
    ...
    {
        out.diagnostic = "TetGen: GenerateMesh failed.";
        return out;
    }
...
{
    // Only TetGen is available today — Netgen/MMG can be added without
