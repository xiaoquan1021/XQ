...
//
// Wraps the concrete generator (TetGen today, optionally Netgen/MMG later)
// so the pipeline can switch engines without touching the Model stage.
...
// Concrete TetGen wrapper.
class XQMESHCOMMON_EXPORT xq_TetGenMeshGenerator : public xq_MeshGenerator
{
public:
    [[nodiscard]] std::string_view Name() const override { return "tetgen"; }
