...
class XQMODULEPATH_EXPORT xq_VesselTracer3D : public mitk::VtkMapper
{
public:
    mitkClassMacro(xq_VesselTracer3D, mitk::VtkMapper)
...
protected:
    xq_VesselTracer3D() = default;
    ~xq_VesselTracer3D() override = default;

    void GenerateDataForRenderer(mitk::BaseRenderer* renderer) override;
    void ResetMapper(mitk::BaseRenderer* renderer) override;

private:
    void CreatePathPolyData(LocalStorage* ls);
    void CreateAnchorPolyData(LocalStorage* ls);
};
