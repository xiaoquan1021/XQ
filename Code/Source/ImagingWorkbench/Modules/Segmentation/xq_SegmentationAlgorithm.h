...
// ---------------------------------------------------------------------------
// Concrete: legacy level-set entry point. It is diagnostic-only so it never
// returns threshold output disguised as a level-set result. Use the factory
// for the real registered ITK implementation.
// ---------------------------------------------------------------------------
