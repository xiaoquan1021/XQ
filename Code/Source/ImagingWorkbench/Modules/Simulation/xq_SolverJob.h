...
public:
    ...
    // Returns empty string when the job is internally consistent enough to
    // export or hand to a backend. DataStorage/model/mesh checks happen in the
    // simulation-prep pipeline because this data model is storage-agnostic.
