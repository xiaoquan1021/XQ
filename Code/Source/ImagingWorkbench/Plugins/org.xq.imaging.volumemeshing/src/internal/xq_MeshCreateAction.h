#ifndef XQ_MESHCREATEACTION_H
#define XQ_MESHCREATEACTION_H
...
class xq_MeshCreateAction : public QObject, public xqmitk::IContextMenuAction
{
  Q_OBJECT
  Q_INTERFACES(xqmitk::IContextMenuAction)
public:
  xq_MeshCreateAction();
  ~xq_MeshCreateAction() override;
