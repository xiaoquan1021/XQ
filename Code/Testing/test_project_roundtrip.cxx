...
static int test_project_full_openproject_roundtrip_custom_xq_types()
{
    ...
    std::cout << "  [OK] All 5 pipeline nodes created with source links\n";
    ...
    std::cout << "  [OK] All 5 nodes found by name after OpenProject\n";
    ...
    // 11e. Solver job fields (solver/wall/BC XML round-trip)
    {
