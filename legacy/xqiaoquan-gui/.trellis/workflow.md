...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/init_developer.py <your-name>
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/get_context.py --mode packages
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/task.py create "<title>" [--slug <name>] [--parent <dir>]
C:/software/anaconda/python.exe ./.trellis/scripts/task.py start <name>
...
C:/software/anaconda/python.exe ./.trellis/scripts/task.py archive <name>
C:/software/anaconda/python.exe ./.trellis/scripts/task.py validate <name>
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/task.py create "<task title>" --slug <name>
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/task.py start <task-dir>
```
