...
Usage (called automatically by task.py hooks):
    C:/software/anaconda/python.exe .trellis/scripts/hooks/linear_sync.py create
    C:/software/anaconda/python.exe .trellis/scripts/hooks/linear_sync.py start
    C:/software/anaconda/python.exe .trellis/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.trellis/tasks/<name>/task.json C:/software/anaconda/python.exe .trellis/scripts/hooks/linear_sync.py sync
