...
Usage:
    C:/software/anaconda/python.exe add_session.py --title "Title" --commit "hash" --summary "Summary" [--package cli]
    C:/software/anaconda/python.exe add_session.py --title "Title" --branch "feat/my-branch"

    # Pipe detailed content via stdin (use --stdin to opt in):
    cat << 'EOF' | C:/software/anaconda/python.exe add_session.py --stdin --title "Title" --summary "Summary"
