...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/get_context.py
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/get_context.py --mode phase
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/get_context.py --mode phase --step <X.X> --platform claude
```
