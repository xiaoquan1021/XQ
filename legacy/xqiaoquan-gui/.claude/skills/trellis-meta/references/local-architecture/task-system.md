...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/task.py create "<child title>" --slug <child-slug> --parent <parent-dir>
```

Link or unlink existing tasks with:

```bash
C:/software/anaconda/python.exe ./.trellis/scripts/task.py add-subtask <parent-dir> <child-dir>
C:/software/anaconda/python.exe ./.trellis/scripts/task.py remove-subtask <parent-dir> <child-dir>
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/task.py create "<title>" --slug <slug>
C:/software/anaconda/python.exe ./.trellis/scripts/task.py start <task>
C:/software/anaconda/python.exe ./.trellis/scripts/task.py current --source
C:/software/anaconda/python.exe ./.trellis/scripts/task.py add-context <task> implement <file> <reason>
C:/software/anaconda/python.exe ./.trellis/scripts/task.py validate <task>
C:/software/anaconda/python.exe ./.trellis/scripts/task.py finish
C:/software/anaconda/python.exe ./.trellis/scripts/task.py archive <task>
```
