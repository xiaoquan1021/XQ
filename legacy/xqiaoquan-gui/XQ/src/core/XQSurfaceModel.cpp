...
void XQSurfaceModel::setTriangleGeometry(std::shared_ptr<XQTriangleSurfaceGeometryHandle> g)
{
    triangleGeometry_ = g;
}

std::shared_ptr<XQTriangleSurfaceGeometryHandle> XQSurfaceModel::triangleGeometry() const
{
    return triangleGeometry_;
}

bool XQSurfaceModel::hasTriangleGeometry() const
{
    return triangleGeometry_ != nullptr;
}
