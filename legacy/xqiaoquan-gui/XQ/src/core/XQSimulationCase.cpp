...
void XQSimulationCase::setFlowSmokeProvenance(
    const FlowSmokeCaseProvenance& provenance)
{
    flowSmokeProvenance_ = provenance;
}

bool XQSimulationCase::hasFlowSmokeProvenance() const
{
    return flowSmokeProvenance_.has_value();
}

const FlowSmokeCaseProvenance& XQSimulationCase::flowSmokeProvenance() const
{
