...
hooks:
  after_create:
    - "C:/software/anaconda/python.exe .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "C:/software/anaconda/python.exe .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "C:/software/anaconda/python.exe .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "C:/software/anaconda/python.exe .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `C:/software/anaconda/python.exe ./.trellis/scripts/task.py current --source`.
