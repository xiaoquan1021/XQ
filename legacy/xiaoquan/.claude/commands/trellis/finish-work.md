...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/get_context.py --mode record
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/task.py archive <task-name>
```
...
```bash
C:/software/anaconda/python.exe ./.trellis/scripts/add_session.py \
  --title "Session Title" \
  --commit "hash1,hash2" \
