...
Usage:
    C:/software/anaconda/python.exe task.py create "<title>" [--slug <name>] [--assignee <dev>] [--priority P0|P1|P2|P3] [--parent <dir>] [--package <pkg>]
    C:/software/anaconda/python.exe task.py add-context <dir> <file> <path> [reason] # Add jsonl entry
    C:/software/anaconda/python.exe task.py validate <dir>              # Validate jsonl files
    C:/software/anaconda/python.exe task.py list-context <dir>          # List jsonl entries
    C:/software/anaconda/python.exe task.py start <dir>                 # Set active task
    C:/software/anaconda/python.exe task.py current [--source]          # Show active task
    C:/software/anaconda/python.exe task.py finish                      # Clear active task
    C:/software/anaconda/python.exe task.py set-branch <dir> <branch>   # Set git branch
    C:/software/anaconda/python.exe task.py set-base-branch <dir> <branch>  # Set PR target branch
    C:/software/anaconda/python.exe task.py set-scope <dir> <scope>     # Set scope for PR title
    C:/software/anaconda/python.exe task.py archive <task-dir>          # Archive completed task
    C:/software/anaconda/python.exe task.py list                        # List active tasks
    C:/software/anaconda/python.exe task.py list-archive [month]        # List archived tasks
    C:/software/anaconda/python.exe task.py add-subtask <parent-dir> <child-dir>     # Link child to parent
    C:/software/anaconda/python.exe task.py remove-subtask <parent-dir> <child-dir>  # Unlink child from parent
"""
...
Usage:
  C:/software/anaconda/python.exe task.py create <title>                     Create new task directory
  C:/software/anaconda/python.exe task.py create <title> --package <pkg>     Create task for a specific package
  C:/software/anaconda/python.exe task.py create <title> --parent <dir>      Create task as child of parent
  C:/software/anaconda/python.exe task.py add-context <dir> <jsonl> <path> [reason]  Add entry to jsonl
  C:/software/anaconda/python.exe task.py validate <dir>                     Validate jsonl files
  C:/software/anaconda/python.exe task.py list-context <dir>                 List jsonl entries
  C:/software/anaconda/python.exe task.py start <dir>                        Set active task
  C:/software/anaconda/python.exe task.py current [--source]                 Show active task
  ...
  C:/software/anaconda/python.exe task.py set-scope <dir> <scope>            Set scope for PR title
  C:/software/anaconda/python.exe task.py archive <task-dir>                 Archive completed task
  C:/software/anaconda/python.exe task.py add-subtask <parent> <child>       Link child task to parent
  C:/software/anaconda/python.exe task.py remove-subtask <parent> <child>    Unlink child from parent
  C:/software/anaconda/python.exe task.py list [--mine] [--status <status>]  List tasks
  C:/software/anaconda/python.exe task.py list-archive [YYYY-MM]             List archived tasks
...
Examples:
  C:/software/anaconda/python.exe task.py create "Add login feature" --slug add-login
  C:/software/anaconda/python.exe task.py create "Add login feature" --slug add-login --package cli
  C:/software/anaconda/python.exe task.py create "Child task" --slug child --parent .trellis/tasks/01-21-parent
  C:/software/anaconda/python.exe task.py add-context <dir> implement .trellis/spec/cli/backend/auth.md "Auth guidelines"
  C:/software/anaconda/python.exe task.py set-branch <dir> task/add-login
  C:/software/anaconda/python.exe task.py start .trellis/tasks/01-21-add-login
  C:/software/anaconda/python.exe task.py current --source
  C:/software/anaconda/python.exe task.py finish
  C:/software/anaconda/python.exe task.py archive add-login
  C:/software/anaconda/python.exe task.py add-subtask parent-task child-task  # Link existing tasks
  C:/software/anaconda/python.exe task.py remove-subtask parent-task child-task
  C:/software/anaconda/python.exe task.py list                               # List all active tasks
  C:/software/anaconda/python.exe task.py list --mine                        # List my tasks only
  C:/software/anaconda/python.exe task.py list --mine --status in_progress   # List my in-progress tasks
""")
...
def main() -> int:
    ...
    if len(sys.argv) >= 2 and sys.argv[1] == "init-context":
        ...
        print(
            "  C:/software/anaconda/python.exe ./.trellis/scripts/get_context.py --mode phase --step 1",
            file=sys.stderr,
        )
        print(
