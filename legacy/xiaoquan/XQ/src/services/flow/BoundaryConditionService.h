...
public:
    ...
    // Builds the command that writes `validated` back onto an existing case node
    // (ReplacePayloadCommand). Validation runs first; failure statuses pass
    // through with a null command.
