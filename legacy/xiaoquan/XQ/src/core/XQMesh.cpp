...
void XQMesh::setSurfaceTriangles(std::shared_ptr<XQTriangleSurfaceGeometryHandle> t)
{
    surfaceTriangles_ = t;
}

std::shared_ptr<XQTriangleSurfaceGeometryHandle> XQMesh::surfaceTriangles() const
{
    return surfaceTriangles_;
}

bool XQMesh::hasSurfaceTriangles() const
{
    return surfaceTriangles_ != nullptr;
}

void XQMesh::setVolumeTets(std::shared_ptr<XQTetVolumeMeshHandle> v)
{
    volumeTets_ = v;
}

std::shared_ptr<XQTetVolumeMeshHandle> XQMesh::volumeTets() const
{
    return volumeTets_;
}

bool XQMesh::hasVolumeTets() const
{
    return volumeTets_ != nullptr;
}
